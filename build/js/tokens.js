...
module.exports = {
  ...
  dimensions: {
    0: {
      key: "{dimensions.0}",
      $value: "0px",
      filePath: "tokens/dimensions.json",
      isSource: true,
      $type: "dimension",
      original: {
        $value: "0px",
  ...
  "composite-examples": {
    typography: {
      heading: {
        key: "{composite-examples.typography.heading}",
        $value: {
        ...
        name: "CompositeExamplesTypographyHeading",
        attributes: {
          category: "composite-examples",
          type: "typography",
          item: "heading",
        },
        path: ["composite-examples", "typography", "heading"],
      },
      body: {
        key: "{composite-examples.typography.body}",
        $value: {
        ...
        name: "CompositeExamplesTypographyBody",
        attributes: {
          category: "composite-examples",
          type: "typography",
          item: "body",
        },
        path: ["composite-examples", "typography", "body"],
      },
    },
  },
  transitions: {
    emphasis: {
      key: "{transitions.emphasis}",
      $value: {
        duration: "300ms",
        delay: "0ms",
      ...
      path: ["transitions", "emphasis"],
    },
    fade: {
      key: "{transitions.fade}",
      $value: {
        duration: "600ms",
        delay: "0ms",
        timingFunction: [0, 0, 0.5, 1],
      },
      filePath: "tokens/object-values.json",
      isSource: true,
      $type: "transition",
      ...
      path: ["transitions", "fade"],
    },
    easingFunctions: {
      accelerate: {
        key: "{transitions.easingFunctions.accelerate}",
        $value: [0.5, 0, 1, 1],
        filePath: "tokens/object-values.json",
        isSource: true,
        $type: "cubicBezier",
        ...
        path: ["transitions", "easingFunctions", "accelerate"],
      },
      decelerate: {
        key: "{transitions.easingFunctions.decelerate}",
        $value: [0, 0, 0.5, 1],
        filePath: "tokens/object-values.json",
        isSource: true,
        $type: "cubicBezier",
        ...
        path: ["transitions", "easingFunctions", "decelerate"],
      },
    },
    durations: {
      instant: {
        key: "{transitions.durations.instant}",
        $value: "0ms",
        filePath: "tokens/object-values.json",
        isSource: true,
        $type: "duration",
        ...
        path: ["transitions", "durations", "instant"],
      },
      short: {
        key: "{transitions.durations.short}",
        $value: "100ms",
        filePath: "tokens/object-values.json",
        isSource: true,
        $type: "duration",
        ...
        path: ["transitions", "durations", "short"],
      },
      medium: {
        key: "{transitions.durations.medium}",
        $value: "300ms",
        filePath: "tokens/object-values.json",
        isSource: true,
        $type: "duration",
        ...
        path: ["transitions", "durations", "medium"],
      },
      long: {
        key: "{transitions.durations.long}",
        $value: "600ms",
        filePath: "tokens/object-values.json",
        isSource: true,
        $type: "duration",
        ...
        path: ["transitions", "durations", "long"],
      },
    },
  },
  borders: {
    ...
    wireframe: {
      ...
      path: ["borders", "wireframe"],
    },
    styles: {
      solid: {
        key: "{borders.styles.solid}",
        $value: "solid",
        filePath: "tokens/object-values.json",
        isSource: true,
        $type: "strokeStyle",
        ...
        path: ["borders", "styles", "solid"],
      },
      dashed: {
        key: "{borders.styles.dashed}",
        $value: {
          dashArray: ["0.5rem", "0.25rem"],
          lineCap: "round",
        },
  ...
  text: {
    fonts: {
      serif: {
        key: "{text.fonts.serif}",
        $value: "Times New Roman, serif",
        filePath: "tokens/text.json",
        isSource: true,
        $type: "fontFamily",
        original: {
          $value: "Times New Roman, serif",
      ...
      sans: {
        ...
        path: ["text", "fonts", "sans"],
      },
    },
    sizes: {
      heading: {
        key: "{text.sizes.heading}",
        $value: "28px",
        filePath: "tokens/text.json",
        isSource: true,
        $type: "fontSize",
      ...
      body: {
        ...
        path: ["text", "sizes", "body"],
      },
    },
    weights: {
      light: {
        key: "{text.weights.light}",
        $value: "thin",
        filePath: "tokens/text.json",
        isSource: true,
        $type: "fontWeight",
        ...
        path: ["text", "weights", "light"],
      },
      regular: {
        key: "{text.weights.regular}",
        $value: "regular",
        filePath: "tokens/text.json",
        isSource: true,
        $type: "fontWeight",
        ...
        path: ["text", "weights", "regular"],
      },
      bold: {
        key: "{text.weights.bold}",
        $value: "extra-bold",
        filePath: "tokens/text.json",
        isSource: true,
        $type: "fontWeight",
        ...
        path: ["text", "weights", "bold"],
      },
    },
    lineHeights: {
      normal: {
        key: "{text.lineHeights.normal}",
        $value: 1.2,
        filePath: "tokens/text.json",
        isSource: true,
        $type: "number",
        ...
        path: ["text", "lineHeights", "normal"],
      },
      large: {
        key: "{text.lineHeights.large}",
        $value: 1.8,
        filePath: "tokens/text.json",
        isSource: true,
        $type: "number",
        ...
        path: ["text", "lineHeights", "large"],
      },
    },
    typography: {
      heading: {
        key: "{text.typography.heading}",
        $value: {
          fontFamily: "Open Sans, sans-serif",
          fontWeight: "extra-bold",
          fontSize: "28px",
        ...
        path: ["text", "typography", "heading"],
      },
      body: {
        key: "{text.typography.body}",
        $value: {
          fontFamily: "Times New Roman, serif",
          fontWeight: "regular",
          fontSize: "16px",
